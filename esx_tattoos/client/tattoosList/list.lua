...
tattoosList = {
	...
	["new_overlays"] = {
		{nameHash = "new_tattoo_01_M", addedX = 0.2, addedY=-0.5,addedZ=0.3, rotZ = 21.1, price = 500},
		{nameHash = "TEST_TATTOO_01_M", addedX = -1.1, addedY=0.2,addedZ=-0.2,rotZ = -431.1, price = 500},
		{nameHash = "DB_tat_head_01_M", addedX = 0.3, addedY=0.2,addedZ=0.7,rotZ = 119.4, price = 500},
	},
}
...
tattoosCategories = {
	...
	{name = "Custom Tattoos", value = "new_overlays"}
}
